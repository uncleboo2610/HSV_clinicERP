...
import { PharmaceuticalGoodsIssueNoteParams, PharmaceuticalGoodsIssueParams, PharmaceuticalGoodsReceiptNoteParams, PharmaceuticalGoodsReceiptParams } from 'src/pharmaceutical-warehouse/utils/types';
